...
#roleArn = 'arn:aws:iam::211385148200:role/AWSEngineer-POC'
roleArn = ''
...
def Replication_Action():
        for pjl in proj_id:
            ...
            for sid, stus in zip(ServerID, MachineStatus):
                print(ServerID[sid])
                print(stus)
                print('Grabbing information for machine with the name ' + sid + ' and ID ' + ServerID[sid])
                print("Proceding With Replication Action " + ReplicationAction)
                machine_data = {'machineIDs': [ServerID[sid]]}
                ...
                if ReplicationAction.lower() == "start":
                    ...
                    print(r.json())
                    if "200" in str(r):
                        print("Replication started for machine..  " + sid)
                    else:
                        print("Replication could not be started for machine..  " + sid)
                        pass
                if ReplicationAction.lower() == "pause":
                    ...
                    if "200" in str(r):
                        print("Replication paused for machine..  " + sid)
                    else:
                        print("Replication could not be paused for machine..  " + sid)
